...
public class StudentManager {
    public static void main(String[] args) {
        ...
        try {
            ...
            properties.load(new FileInputStream("E:\\projects\\chapter34\\src\\homework2\\config.properties"));
            ...
            statement.executeUpdate( "CREATE TABLE IF NOT EXISTS Stu (" +
            ...
            String sql = "INSERT INTO Stu(ssn,firstname,mi,lastname,birthdate,street,phone,zipcode,deptid)" +
                    "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)";
